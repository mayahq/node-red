...
var needsPermission;
var runtimeAPI;
var log = require("@mayahq/util").log;
var i18n = require("@mayahq/util").i18n;
...
module.exports = {
    ...
    start: function() {
        var catalogPath = path.resolve(path.join(path.dirname(require.resolve("@mayahq/editor-client")),"locales"));
