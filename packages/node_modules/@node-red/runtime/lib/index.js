...
var redUtil = require("@mayahq/util");
var log = redUtil.log;
 ...
 * @param {AdminAPI} adminApi - an instance of @mayahq/editor-api. <B>TODO</B>: This needs to be
 *                              better abstracted.
 * @memberof @mayahq/runtime
 */
...
module.exports = {
    ...
    /**
    * @memberof @mayahq/runtime
    * @mixes @mayahq/runtime_comms
    */
    comms: externalAPI.comms,
    /**
    * @memberof @mayahq/runtime
    * @mixes @mayahq/runtime_flows
    */
    flows: externalAPI.flows,
    /**
    * @memberof @mayahq/runtime
    * @mixes @mayahq/runtime_library
    */
    library: externalAPI.library,
    /**
    * @memberof @mayahq/runtime
    * @mixes @mayahq/runtime_nodes
    */
    nodes: externalAPI.nodes,
    /**
    * @memberof @mayahq/runtime
    * @mixes @mayahq/runtime_settings
    */
    settings: externalAPI.settings,
    /**
    * @memberof @mayahq/runtime
    * @mixes @mayahq/runtime_projects
    */
    projects: externalAPI.projects,
    /**
    * @memberof @mayahq/runtime
    * @mixes @mayahq/runtime_context
    */
