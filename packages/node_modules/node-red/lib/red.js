...
var runtime = require("@mayahq/runtime");
var redUtil = require("@mayahq/util");

var api = require("@mayahq/editor-api");
...
module.exports = {
    ...
    init: function(httpServer, userSettings) {
        ...
        if (!userSettings.coreNodesDir) {
            userSettings.coreNodesDir = path.dirname(require.resolve("@mayahq/nodes"))
        }
